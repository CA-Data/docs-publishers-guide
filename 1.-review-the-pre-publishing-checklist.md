...
| <img src=".gitbook/assets/Vector.png" alt="" data-size="line"> Data Steward                                                                                          | <img src=".gitbook/assets/Vector(1).png" alt="" data-size="line"> Data Coordinator                                                                                                      | <img src=".gitbook/assets/Vector(2).png" alt="" data-size="line"> Data Custodian                                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
* [ ] **Send a link to this handbook to the people you've identified.** Give them a heads up you'll be working on publishing open data - [you can use this email template as a starting point](reference/templates.md#invite-your-team-to-help-you-publish-open-data).
* [ ] **Ensure that each reviewer on your dataset has publishing rights on the State open data portal.** If you don't know or need someone to be added, [send an email to the open data team to verify](mailto:opendata@state.ca.gov?subject=\[publisher\_handbook]%20Requesting%20publisher%20permissions%20on%20data.ca.gov).
...
{% file src=".gitbook/assets/California Open Data Metadata Template.xlsx" %}
...
By the time you publish, you should create meaningful definitions, which is covered in step [3 Create Metadata and Data Dictionary](3.-create-metadata-and-data-dictionary.md). You'll use this same template in that section. You will eventually copy certain elements over when you upload your dataset on the portal in section [4 Upload the Dataset](4.-upload-the-dataset.md).
{% endhint %}
...
* [ ] **Discuss with your data custodian and other IT contacts what's possible.** [See this template email for a starting point](reference/templates.md#reach-out-to-your-it-team-about-publishing).
