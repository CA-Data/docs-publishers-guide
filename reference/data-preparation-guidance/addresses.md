...
* Where appropriate, use a valid Enterprise Address System address
  * EAS addresses capture addresses input by DBI staff, see the [section on address numbers for more detail](../../standard-reference-data/basemap/address-numbers.md)
...
| Street Name Pretype | Text | A word or phrase that precedes the Street Name and identifies a type of thoroughfare in a Complete Street Name: **US Route** 101, San Francisco, CA | [Official list of street names maintained by Public Works](https://data.sfgov.org/Geographic-Locations-and-Boundaries/Street-Names/6d9h-4u5v) |
