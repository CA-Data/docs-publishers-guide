...
* [ ] **Ensure that each reviewer on your dataset has publishing rights on the State open data portal.** If you don't know or need someone to be added, [send an email to the open data team to verify](mailto:opendata@state.ca.gov?subject=?subject=[publisher_handbook]%20Requesting%20publisher%20permissions%20on%20data.ca.gov).
