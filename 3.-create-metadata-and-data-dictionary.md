...
{% hint style="info" %}
\*\*\*\*:open\_file\_folder: **Additional** **Resources.** Refer to [Metadata Field Definitions ](reference/metadata-field-definitions.md)for definitions of and further guidance on metadata fields.
{% endhint %}
...
:x:<mark style="color:red;">\[1]:</mark> Uses an acronym in the title that is not clearly understood by the public.

:x:<mark style="color:red;">\[2]:</mark> Uses CA in the title. This creates redundancy, as all datasets published on the CA Open Data Portal pertain to California.
{% endtab %}
...
:x:<mark style="color:red;">\[1]:</mark> Includes an unnecessary date range. This could lead to a need to update the title, and failing to update it could lead to potential misinformation about the content of the dataset.
{% endtab %}
{% endtabs %}
...
:white\_check\_mark:<mark style="color:blue;">\[1]:</mark> Includes relevant acronyms and properly defines them.

:white\_check\_mark:<mark style="color:blue;">\[2]:</mark> Lists data source.

:white\_check\_mark:<mark style="color:blue;">\[3]:</mark> Specifies data collection method.

:white\_check\_mark:<mark style="color:blue;">\[4]:</mark> Specifies limitations of dataset.
{% endtab %}
...
:white\_check\_mark:<mark style="color:blue;">\[2]:</mark> Specifies data source.

:white\_check\_mark:<mark style="color:blue;">\[3]:</mark> Lists the program this data supports.

:white\_check\_mark:<mark style="color:blue;">\[4]:</mark> Clearly lists the contents of the dataset.

:white\_check\_mark:<mark style="color:blue;">\[5]:</mark> Includes relevant guidance on how to best utilize the data resource.
{% endtab %}
{% endtabs %}
...
| **Dos**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | **Donts**                                                                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| <p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> Be precise, unambiguous, and concise.</p><p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> Include relevant acronyms, but make sure to clearly define them at least once.</p><p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> If the value is a date, document the time zone of the recording, e.g. PST (Pacific Daylight Time).</p><p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> If the values are calculated, the source of raw data and calculation method should be included.</p><p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> Include units of measurement if applicable.</p><p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> Include any known limitations of the data collected, e.g. groundwater levels were not measured in the month of January.</p><p><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span> If the field is a category, include the list of allowable values, e.g. allowable or expected range.</p> | :x: Avoid writing these definitions from the perspective of an expert; write with the average public user in mind. |
...
:white\_check\_mark:<mark style="color:blue;">\[1]</mark>: Clear and concise description of the field.

:white\_check\_mark:<mark style="color:blue;">\[2]</mark>: Lists limitations of dataset.

:white\_check\_mark:<mark style="color:blue;">\[3]</mark>: Specifies data source.

:white\_check\_mark:<mark style="color:blue;">\[4]</mark>: Lists possible range of data.
{% endtab %}
...
:x:<mark style="color:red;">\[1]</mark>: Uses an uncommon acronym without defining it. Alternatively, define the acronym as "Big Blue Bus (BBB)".

:white\_check\_mark:<mark style="color:blue;">\[2]</mark>: Lists allowable values.
{% endtab %}
{% endtabs %}
